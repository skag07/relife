...
info@RElife.com
    ...
    <span class="v35_284">About us </span><span class="v35_285"> </span>
...
info@RElife.com
    ...
    <span class="v35_311">Contact us </span>
    ...
    <div class="d-flex">
        ...
        <div class=" align-items-center container p-5 col-md-6" style="margin-top:20%;background-color:rgba(66,80,62,1); border-radius:30px;">
            ...
            <form:form action="/login" method="post" modelAttribute="newLogin">
                ...
                <input type="submit" value="Register" class="btn" style="background-color:rgba(218,180,115,1); color:white;"/>
            </form:form>
